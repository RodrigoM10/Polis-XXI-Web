        ...
        <div className={`blog-card ${infoCardAxes.position} px-0 mx-auto`}>
                <div className="meta">
                    ...
                    <ul className="details d-flex flex-column justify-content-center aling-items-center" >
                        ...
                        <li className='my-2 '><Link to={infoCardAxes.link}  className='text-decoration-none text-white'>{infoCardAxes.list.item_2}</Link></li>
                        <li className='my-2 '><Link to={infoCardAxes.link} className='text-decoration-none text-white'>{infoCardAxes.list.item_3}</Link></li>
                        <li className='my-2 '><Link to={infoCardAxes.link} className='text-decoration-none text-white'>{infoCardAxes.list.item_4}</Link></li>
                    </ul>
                </div>
